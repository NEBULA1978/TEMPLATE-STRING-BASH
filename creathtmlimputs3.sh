...
function mostrar_menu() {
    clear
    echo "Menú:"
    echo "1. Mostrar valores actuales"
    echo "2. Cambiar valores"
    echo "3. Generar HTML y salir"
    echo "4. Salir sin generar HTML"
}
...
while true; do
    ...
    case $opcion in
        1)
            ...
            echo "id1header: $id1header"
            echo "idmain: $idmain"
            echo "idsection: $idsection"
            echo "claseheader: $claseheader"
            echo "namecabecera: $namecabecera"
            echo "navclass: $navclass"
            echo "ejemplojs: $ejemplojs"
            echo "href1: $href1"
            echo "href2: $href2"
            echo "href3: $href3"
...
<body>
    ...
    <footer class="border-grey">
        <p>2022 Desarrollo útil</p>
            ...
            ;;
        4)
            # Salir sin generar HTML
            echo "Saliendo sin generar HTML."
            exit
            ;;
        *)
            # Opción no válida
